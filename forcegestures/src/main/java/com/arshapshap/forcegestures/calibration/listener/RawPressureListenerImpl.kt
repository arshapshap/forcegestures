 ...
 * and dispatch raw pressure events to the provided [OnCalibrationPressureListener].
 *
 ...
 *
 * @property listener The [OnCalibrationPressureListener] instance that will receive the raw pressure events, or null if no listener is set.
 */
class RawPressureListenerImpl(
    private val listener: OnCalibrationPressureListener?
